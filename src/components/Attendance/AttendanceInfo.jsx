...
function AttendanceInfo() {
  return (
    <ul className={styles.infoList}>
      ...
      />
      <AttendanceInfoItem
        img={`https://d2f3kqq80r3o3g.cloudfront.net/free-icon-font-clock-five-7602640 1.svg`}
        text='금일 입실 시간'
        value='08:10'
      />
      <AttendanceInfoItem
        img={`https://d2f3kqq80r3o3g.cloudfront.net/free-icon-font-clock-nine-7602655.svg`}
        text='금일 퇴실 시간'
        value='17:00'
      />
    </ul>
