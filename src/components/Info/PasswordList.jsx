  ...
  return (
    <div className={styles.wrapper}>
      ...
      <InputPassword 
        ...
        setEditPassword={(value) => setPasswordInfo(prev => ({...prev , editpassword: value}))}
      />
      <InputPassword 
        title='새 비밀번호 확인'
        value={passwordInfo.correctEditpassword}
        setEditPassword={(value) => setPasswordInfo(prev => ({...prev, correctEditpassword: value}))}
      />
      {isShowingEditPWError && <span className={styles.validateMessage}>새 비밀번호가 일치하지 않아요.</span>}
      <div className={styles.align}>
        <button onClick={onCancelEditPassword} className={styles.cancelButton}>취소</button>
